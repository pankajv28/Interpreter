...
class SourceToSourceCompiler(NodeVisitor):
    ...
    def visit_ProcedureDecl(self, node):
        ...
        for param in node.params:
            ...
            formal_params.append(
                '%s : %s' % (param_name + scope_level, param_type.name+ scope_level)
            )
        ...
        result_str += self.visit(node.block_name)
    ...
    def visit_Var(self, node):
        ...
        return '<%s:%s>' % (var_name + scope_level, var_symbol.type.name+ scope_level)
